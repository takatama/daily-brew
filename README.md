...
```bash
curl -i "http://127.0.0.1:8787/news?lang=ja" -H "Origin: https://coco-timer.pages.dev"
curl -i "http://127.0.0.1:8787/news?lang=en" -H "Origin: https://coco-timer.pages.dev"
```
